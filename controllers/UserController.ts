...
class UserController {
    ...
    register = asyncHandler( async (req: Request, res: Response, next: NextFunction) => {
        ...
        const users = await pool.query(
            `INSERT INTO accounts (name, email, password, avatar, public_key, private_key, account_type) VALUES($1, $2, $3, $4, $5, $6, $7) RETURNING *`, [userName, email, safePassword, avatar || '', publicKey, privateKey, accountType]
        );
